        ...
        <div id="mws-sidebar">
            ...
            <div id="mws-navigation">
                ...
                <ul>
                    ...
                    <li <?php echo($cp=='productcat_reg.php' || $cp=='add_productcat.php')?'class="active"':''?>><a href="productcat_reg.php"><i class="icon-briefcase"></i> Product Catrgory</a></li>

                    <li <?php echo($cp=='product_reg.php' || $cp=='add_product.php')?'class="active"':''?>><a href="product_reg.php"><i class="icon-bag"></i> Product Register</a></li>
                    ...
                    <li>
                        <li class="active"><a href="#"><i class="icon-list"></i> Products</a></li>
                        <ul>
                            ...
                            <li><a href="form_wizard.html">client Product Details</a></li>
                        </ul>
                    </li>
                </ul>
            </div>         
