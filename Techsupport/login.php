    ...
    <div id="mws-login-wrapper">
        <div id="mws-login">
            ...
            <div id="mws-login-form">
                <form class="mws-form" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                    ...
                    <div class="mws-form-row">
                        <div class="mws-form-item">
                            <input type="password" name="password" name="password" id="password" class="mws-login-password required" placeholder="password">
                        </div>
                    </div>
                ...
                <?php
                          if(isset($_POST['login'])){
                            include ("include/config.inc.php");
                            //$status = mysqli_real_escape_string($con, $_SESSION['status']);
